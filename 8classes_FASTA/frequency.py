...
#also a good choice.
output_file = open('RF02683.csv','w')
...
output_file.write('Gene\tType\tA\tT\tG\tC\tAA\tAC\tAG\tAU\tCA\tCC\tCG\tCU\tGA\tGC\tGG\tGU\tUA\tUC\tUG\tUU\n')
...
for cur_record in SeqIO.parse(input_file, "fasta") :
    ...
    output_line = '%s\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\t%i\n' % \
    (gene_name, 23, A_count, T_count, G_count, C_count, AA_count, AC_count, AG_count, AU_count, CA_count, CC_count, CG_count, CU_count, GA_count, GC_count, GG_count, GU_count, UA_count, UC_count, UG_count, UU_count)
