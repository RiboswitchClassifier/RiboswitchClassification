...
# file_name = 'processed_datasets/24_riboswitches_final_train.csv'
# Data_train.to_csv(file_name, sep=',', encoding='utf-8', index=False)
# file_name = 'processed_datasets/24_riboswitches_final_test.csv'
# Data_test.to_csv(file_name, sep=',', encoding='utf-8', index=False)


# [60661 rows x 22 columns] - When Duplicates are removed
# [63499 rows x 22 columns]