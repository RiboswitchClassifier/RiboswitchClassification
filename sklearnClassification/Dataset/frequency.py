...
for cur_record in SeqIO.parse(input_file, "fasta") :
    ...
    (gene_name, 3, A_count, T_count, G_count, C_count, AA_count, AC_count, AG_count, AU_count, CA_count, CC_count, CG_count, CU_count, GA_count, GC_count, GG_count, GU_count, UA_count, UC_count, UG_count, UU_count)
